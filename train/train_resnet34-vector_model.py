...
from helpers.generatorutils import SpectrumGenerator
...
def main():
    ...
    parser.add_argument('--n_epochs', dest='n_epochs', default=40, type=int, action='store', help='Number of training epochs')
    ...
    model.build_model(len(np.unique(data['labels'])), args.model_dir)
...
# python ./train/train_resnet34-vector_model.py --data_source_vox1 "/beegfs/mm10572/voxceleb1" --data_source_vox2 "/beegfs/mm10572/voxceleb2" --aug 3 --vad True --noises_dir "./data/noise" --model_dir "./models/resnet34vox/pre-trained"
