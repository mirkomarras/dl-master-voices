...
class VggVox(Model):
    ...
    def build(self, classes=0, embs_size=512, embs_name='embs', loss='softmax', aggregation='gvlad', vlad_clusters=10, ghost_clusters=2, weight_decay=1e-3, mode='train'):
