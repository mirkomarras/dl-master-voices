...
def main():
    ...
    parser.add_argument('--seed_voice', dest='seed_voice', default='data/voxceleb2/dev/id00012/21Uxsk56VDQ/00001.m4a', type=str, action='store', help='Path to the seed voice that will be optimized to become a master voice')
