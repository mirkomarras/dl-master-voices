...
from src.models.verifier.tf_keras.resnet50vox.model import ResNet50Vox
from src.models.verifier.tf_keras.resnet34vox.model import ResNet34Vox
from src.models.verifier.tf_keras.xvector.model import XVector
from src.models.verifier.tf_keras.vggvox.model import VggVox
...
if __name__ == '__main__':
    ...
    model.train(n_epochs=args.n_epochs, n_steps_per_epoch=10, validation_data=validation_data, validation_interval=args.val_interval, learning_rate=args.learning_rate, dropout_proportion=args.drop_prop, initializer=iterator.initializer)
