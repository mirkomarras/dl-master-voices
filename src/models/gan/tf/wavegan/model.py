...
from src.helpers.datapipeline import data_pipeline_gan
from src.models.gan.tf.model import GAN
...
class WaveGAN(GAN):
  ...
  def __init__(self, id='', gender='neutral'):
    ...
    tf_dir = os.path.join('.', 'data', 'pt_models', self.name, 'tf', self.gender)
