...
import models.wavegan.loader as loader
from models.wavegan.wavegan import WaveGANGenerator, WaveGANDiscriminator
...
if __name__ == '__main__':
  ...
  data_args.add_argument('--data_source_vox1', type=str, help='Data directory containing *only* audio files to load')
  data_args.add_argument('--data_source_vox2', type=str, help='Data directory containing *only* audio files to load')
  data_args.add_argument('--data_gender', type=str, help='Gender m f')
  ...
  wavegan_args.add_argument('--wavegan_genr_pp', action='store_true', dest='wavegan_genr_pp', help='If set, use post-processing filter')
  ...
  parser.set_defaults(
    data_source_vox1=None,
    data_source_vox2=None,
    data_gender='',
    data_sample_rate=16000,
    data_slice_len=16384,
    data_num_channels=1,
  ...
  if args.mode == 'train':
    ...
    data = getData(args.data_source_vox1, args.data_source_vox2, gender=args.data_gender)
    fps = data['paths']

    print('Found {} total files'.format(len(fps)))
