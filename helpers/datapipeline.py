...
def data_pipeline_verifier(x, y, classes, augment=1, sample_rate=16000, n_seconds=3, batch=64, prefetch=1024):
    ...
    dataset = tf.data.Dataset.from_generator(lambda: data_pipeline_generator_verifier(x, y, classes, augment=augment, sample_rate=sample_rate, n_seconds=n_seconds),
